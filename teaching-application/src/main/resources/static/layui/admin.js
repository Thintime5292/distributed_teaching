...
;layui.define("view", function (e) {
        ...
        x = "layui-icon-spread-left", C = "layadmin-side-shrink", k = "LAY-system-side-menu", P = {
            v: "1.4.0 std", req: l.req, exit: l.exit, escape: function (e) {
                ...
                var t, i = e.seconds, n = a(e.elem), l = function (a) {
                    i--, i < 0 ? (n.removeClass(f).html("èŽ·å–éªŒè¯ç "), i = e.seconds, clearInterval(t)) : n.addClass(f).html(i + "ç§’åŽé‡èŽ·"), a || (t = setInterval(function () {
                        l(!0)
                    }, 1e3))
                };
                e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode), n.on("click", function () {
                    ...
                    if (i === e.seconds && !a(this).hasClass(f)) {
                        if (!/^1\d{10}$/.test(n)) return t.focus(), layer.msg("è¯·è¾“å…¥æ­£ç¡®çš„æ‰‹æœºå·");
                        ...
                        P.req(a.extend(!0, {
                            url: "/auth/code", type: "get", data: {phone: n}, success: function (a) {
                                layer.msg("éªŒè¯ç å·²å‘é€è‡³ä½ çš„æ‰‹æœºï¼Œè¯·æ³¨æ„æŸ¥æ”¶", {
                                    icon: 1,
                                    shade: 0
            ...
            flexible: function (e) {
                ...
                e.off("keypress").on("keypress", function (a) {
                    if (this.value.replace(/\s/g, "") && 13 === a.keyCode) {
                        var t = e.attr("lay-action"), i = e.attr("lay-text") || "æœç´¢";
                ...
                F.note.index = P.popup({
                    ...
                    content: '<textarea placeholder="å†…å®¹"></textarea>',
                    resize: !1,
                    success: function (e, a) {
                        var i = e.find("textarea"),
                            l = void 0 === t ? "ä¾¿ç­¾ä¸­çš„å†…å®¹ä¼šå­˜å‚¨åœ¨æœ¬åœ°ï¼Œè¿™æ ·å³ä¾¿ä½ å…³æŽ‰äº†æµè§ˆå™¨ï¼Œåœ¨ä¸‹æ¬¡æ‰“å¼€æ—¶ï¼Œä¾ç„¶ä¼šè¯»å–åˆ°ä¸Šä¸€æ¬¡çš„è®°å½•ã€‚æ˜¯ä¸ªéžå¸¸å°å·§å®žç”¨çš„æœ¬åœ°å¤‡å¿˜å½•" : t;
                ...
                a.ajax({
                    ...
                    success: function (e) {
                        0 === e.status ? e.version === P.v.replace(/\s|pro|std/g, "") ? layer.alert("å½“å‰ç‰ˆæœ¬å·²ç»æ˜¯æœ€æ–°ç‰ˆæœ¬") : layer.alert("æ£€æŸ¥åˆ°æ›´æ–°ï¼Œæ˜¯å¦å‰å¾€ä¸‹è½½ï¼Ÿ", {btn: ["æ›´æ–°", "æš‚ä¸"]}, function (e) {
                        ...
                        }) : 1 == e.status ? layer.alert(e.msg, {btn: ["ç™»å…¥", "æš‚ä¸"]}, function (e) {
                            layer.close(e), layer.open({
                                type: 2,
                    ...
                    error: function (e) {
                        layer.msg("è¯·æ±‚å¼‚å¸¸ï¼Œè¯·é‡è¯•", {shift: 6})
                    }
                })
            }, im: function () {
                P.popup({
    ...
    !function () {
        ...
        e.theme ? P.theme(e.theme) : n.theme && P.initTheme(n.theme.initColorIndex), "pageTabs" in layui.setter || (layui.setter.pageTabs = !0), n.pageTabs || (a("#LAY_app_tabs").addClass(c), u.addClass("layadmin-tabspage-none")), s.ie && s.ie < 10 && l.error("IE" + s.ie + "ä¸‹è®¿é—®å¯èƒ½ä¸ä½³ï¼ŒæŽ¨èä½¿ç”¨ï¼šChrome / Firefox / Edge ç­‰é«˜çº§æµè§ˆå™¨", {
            offset: "auto",
            id: "LAY_errorIE"
        })
